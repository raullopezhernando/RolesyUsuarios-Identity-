...
namespace RolesyUsuarios.Controllers
{
    public class ObrasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,AnioPublicacion,ImagenObra,AutorId")] Obra obra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,AnioPublicacion,ImagenObra,AutorId")] Obra obra)
        {
            if (id != obra.Id)
            {
                return NotFound();
